...
quiz(  
  question("Sea P(A) = 0.50 y P(B) = 0.30, donde A y B son eventos independientes. Entonces se puede afirmar que: ", allow_retry = TRUE,
    ...
    answer("P(B | A) = 0.50 ", message = "No, pero no...inténtalo de nuevo!"),
    answer("P(A ∩ B) =0.50", message = "Incorrecto. Intenta de nuevo!."),
    answer("P(A ∪ B)= 0.50", message = "No...inténtalo de nuevo!"),
...
quiz(  
  question("Sea P(A) = 0.50 y P(B) = 0.30 y P(A ∩ B) = 0.20, podemos afirmar que",  allow_retry = TRUE,
    answer("P(A') = 0.3", message = "No...inténtalo de nuevo!"),
    answer("P(B') = 0.50 ", message = "No, pero no...inténtalo de nuevo!"),
...
quiz(  
  ...
  allow_retry = TRUE,
    ...
    answer("P(A ∩ M) = 60/478", message = "No, pero no...inténtalo de nuevo!"),
    answer("P(H ∩ B) = 120/810", correct = TRUE),
    answer("P(M | B) = 280/810", message = "No...inténtalo de nuevo!"),
    # Si no cambiamos estos textos en los botones, se mostrarán en Inglés  
    submit_button = "Enviar respuesta",
    correct = "Correcto!",
    incorrect = "Incorrecto!",
...
quiz(  
  ...
  allow_retry = TRUE,
    ...
    answer("P(A′) = 1 − P(A) ", message = "No, pero no...inténtalo de nuevo!"),
    answer("P(A∪B) = P(A) + P(B)", correct = TRUE), 
    answer("0 ≤ P(A) ≤ 1", message = "No...inténtalo de nuevo!"),
    # Si no cambiamos estos textos en los botones, se mostrarán en Inglés  
    submit_button = "Enviar respuesta",
    correct = "Correcto!",
    incorrect = "Incorrecto!",
